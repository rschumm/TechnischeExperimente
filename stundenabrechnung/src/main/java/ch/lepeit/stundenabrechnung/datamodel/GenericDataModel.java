...
public class GenericDataModel<T> extends ExtendedDataModel<T>
	...
	private Expression<Boolean> createFilterCriteria(
		...
		if (filterFields != null && !filterFields.isEmpty()) {
			...
			for (FilterField filterField : filterFields) {
				...
				Expression<Boolean> predicate = createFilterCriteriaForField(
						propertyName, filterValue, root, criteriaBuilder);
